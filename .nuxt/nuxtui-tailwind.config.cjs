      ...
      const { customSafelistExtractor, generateSafelist } = require("/Users/sv/dev/tg-nuxt-app/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "/Users/sv/dev/tg-nuxt-app/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/Users/sv/dev/tg-nuxt-app/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
