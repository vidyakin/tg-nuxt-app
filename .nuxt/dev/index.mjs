...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/ohash/dist/index.mjs';
...
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/vue/index.mjs';
import { basename } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/sv/dev/tg-nuxt-app/.nuxt/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/sv/dev/tg-nuxt-app/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "BOT_TOKEN": "6348151797:AAF_VM9uFVC0I76ids6ZHwyhNVXu5AcSrcc"
  },
  "icon": {
...
const serverAssets = [{"baseName":"server","dir":"/Users/sv/dev/tg-nuxt-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sv/dev/tg-nuxt-app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sv/dev/tg-nuxt-app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sv/dev/tg-nuxt-app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sv/dev/tg-nuxt-app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/sv/dev/tg-nuxt-app/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _zhnhvvB1iJ = (function(nitro) {
...
const _hHkkqyuZvz = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _Do3Tdt = defineCachedEventHandler(async (event) => {
...
const getClientManifest = () => import('file:///Users/sv/dev/tg-nuxt-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/sv/dev/tg-nuxt-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
